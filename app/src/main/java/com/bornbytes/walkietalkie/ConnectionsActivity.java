...
import static com.bornbytes.walkietalkie.Constants.TAG;
...
public abstract class ConnectionsActivity extends AppCompatActivity {
    ...
    protected void startDiscovering() {
        ...
        mConnectionsClient.startDiscovery(getServiceId(), new EndpointDiscoveryCallback() {
                    @Override
                    public void onEndpointFound(String endpointId, DiscoveredEndpointInfo info) {
                        logD(String.format("onEndpointFound(endpointId=%s, serviceId=%s, endpointName=%s)", endpointId, info.getServiceId(), info.getEndpointName()));
